export const posts = [
  ...
  export const projectsData = [
    ...
    },
    {
      ...
      category: 'Software',
      description: 'Contributed to multiple front-end and back-end solutions, including designing web apps with C#, .NET, and JavaScript during my two years as a full-stack developer.',
